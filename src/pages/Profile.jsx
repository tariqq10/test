    ...
    <div className="profile-container">
      ...
      <div className="account-settings">
        ...
        <form action="/update-profile" method="POST">
          ...
          <input type="email" id="new-email" name="new-email" defaultValue="johndoe@example.com" /><br /><br />

          <label htmlFor="new-phone">New Phone Number:</label><br />
          <input type="tel" id="new-phone" name="new-phone" defaultValue="+1 234 567 890" /><br /><br />

          <label htmlFor="new-password">New Password:</label><br />
          <input type="password" id="new-password" name="new-password" placeholder="Enter new password" /><br /><br />
